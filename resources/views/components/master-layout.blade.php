  ...
  <body>
   <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavId">
           <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
               ...
               <li class="nav-item">
                   <a class="nav-link" href="{{ route('list-produits') }} ">Produits</a>
               </li>
               <li class="nav-item dropdown">
                   ...
                   <div class="dropdown-menu" aria-labelledby="dropdownId">
                       <a class="dropdown-item" href="{{ route('produits.create') }}">Ajouter</a>
   ...
   <div class="container-fluid bg-dark mt-5 pt-4 pb-4 d-flex justify-content-center">
    <footer class="text-white">
        © Copyright 2021 | Shopyfy | Tous droits reservés
    </footer>
   </div>
