...
Route::get("list-produits", [ProduitController::class, "index"])->name("list-produits");
//Route::get('/', [MainController::class, "accueil"])->name("accueil");
Route::resource("produits", ProduitController::class);
});
Route::get("export-produits",[MainController::class, "exportProduits"])->name("produitsExport");
Route::get('/', [MainController::class, "accueil"])->name("accueil");
